...
def Get_Dataset(experiment, approach):
    ...
    if experiment == 'pa100k':
        val_dataset = MultiLabelDataset(root='data_path/',
                    label='./data_path/detected_image/image.txt', transform=transform_test)
        return val_dataset, attr_nums['pa100k'], description['pa100k']

    elif experiment == 'rap':
        val_dataset = MultiLabelDataset(root='data_path/',
                    label='data_path/detected_image/image.txt', transform=transform_test)
        return  val_dataset, attr_nums['rap'], description['rap']
